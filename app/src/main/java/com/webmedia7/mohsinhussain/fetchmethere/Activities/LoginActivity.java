...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //sdHzDJT0A0pDf9cJlwE7tm8BKnhBHDowU9fTSFLn  -- Firebase Secret

/*
        Map<String, Object> authPayload = new HashMap<String, Object>();
        authPayload.put("uid", "1");
        authPayload.put("firstName", "Mohsin");
        authPayload.put("lastName", "Hussain");
        authPayload.put("phone", "009712022892");

        TokenGenerator tokenGenerator = new TokenGenerator("sdHzDJT0A0pDf9cJlwE7tm8BKnhBHDowU9fTSFLn");
...
*/
        ...
        registerButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Intent chooseUserActivtyIntent = new Intent(LoginActivity.this, ChooseUserActivity.class);
    ...
    public void attemptLogin() {
        ...
        if(!TextUtils.isEmpty(phone) && !isPhoneValid(phone)){
            mPhoneView.setError("This phone number is too short or invalid");
    ...
    private boolean isPhoneValid(String number){
        return (number != null && number.matches("639[0-9]{9}"));
...
//                finish();
                Intent chooseUserActivtyIntent = new Intent(LoginActivity.this, ChooseUserActivity.class);
                chooseUserActivtyIntent.putExtra("isLogin", true);
                startActivity(chooseUserActivtyIntent);
            } else {

...
public class ArcMenu extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        controlLayout = (ViewGroup) findViewById(R.id.control_layout);
//        controlLayout.setLayoutParams(new LayoutParams(100,200));
    ...
    private void applyAttrs(AttributeSet attrs) {
        if (attrs != null) {
            ...
            Log.v("Denstiy", "Density = " + metrics.densityDpi);

            android.view.ViewGroup.LayoutParams params = controlLayout.getLayoutParams();
            ...
            params.width = vGroupSize;
            params.height = vGroupSize;
            controlLayout.setLayoutParams(params);
            mArcLayout.setChildSize(newChildSize, radius);
